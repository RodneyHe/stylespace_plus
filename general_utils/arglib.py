...
class BaseArgs(ABC):
    ...
    def add_args(self):
        ...
        self.parser.add_argument("--load_checkpoint", default=False)
        ...
        self.parser.add_argument("--results_dir", type=str, default="./output")
        self.parser.add_argument("--log_debug", action="store_true")

        # Other
        self.parser.add_argument("--debug", action="store_true")
        self.parser.add_argument("--cache", action="store_true", default=True)
...
class TrainArgs(BaseArgs):
    ...
    def add_args(self):
        ...
        self.parser.add_argument("--not_improved_exit", type=int, default=10,
                                 help="After how many not-improved test to exit")
        BaseArgs.add_bool_arg(self.parser, "test_with_arcface", default=False)
        BaseArgs.add_bool_arg(self.parser, "parameter_embedding", default=False)
